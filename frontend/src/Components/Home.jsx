  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        {!user && (
          <div className="relative bg-gradient-to-br from-emerald-50 via-cyan-50 to-blue-100 py-20 px-4 mx-4 mt-16 rounded-3xl overflow-hidden shadow-2xl border border-white/50">
            {/* Background Pattern */}
            ...
            <div className="relative z-10 max-w-6xl mx-auto text-center">
              <div className="inline-flex items-center gap-3 bg-white/50 backdrop-blur-xl px-6 py-3 rounded-full mb-8 border border-white/60">
                <Zap className="w-5 h-5 text-emerald-600 animate-pulse" />
                <span className="text-sm font-bold text-gray-800">Unlock Premium Features</span>
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-8 mb-12">
                <div className="text-center">
                  ...
                  <div className="text-gray-600 font-medium">Medicines</div>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-black text-cyan-600 mb-2">10K+</div>
                  <div className="text-gray-600 font-medium">Doctors</div>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-black text-blue-600 mb-2">1M+</div>
                  <div className="text-gray-600 font-medium">Prescriptions</div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-20">
          ...
          {/* Loading State */}
          {displayIsSearching && (
            <div className="flex flex-col justify-center items-center py-32 bg-gradient-to-br from-gray-50 to-white rounded-3xl shadow-xl border-2 border-gray-100 animate-scaleIn">
              ...
              <div className="mt-8 text-center">
                ...
                <span className="text-2xl text-gray-700 font-bold">Searching Medicines</span>
          ...
          {!displayIsSearching && displayMedicines.length > 0 && (
            <div className="animate-fadeInUp">
              <div className="text-center mb-16">
                ...
                <p className="text-gray-600 text-xl font-semibold">{displayMedicines.length} medicines found</p>
              </div>
          ...
          {!displayIsSearching && displaySearchQuery && displayMedicines.length === 0 && (
            <div className="text-center py-32 bg-gradient-to-br from-red-50 to-orange-50 rounded-3xl border-3 border-red-200 shadow-lg animate-fadeInUp">
              <div className="relative">
              ...
              <h3 className="text-4xl font-black text-gray-900 mb-4">No medicines found</h3>
              <p className="text-gray-700 text-xl mb-8 max-w-md mx-auto">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <button
                  ...
                  className="bg-white text-gray-700 px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 border border-gray-300"
                >
          ...
          {!displaySearchQuery && displayMedicines.length === 0 && !displayIsSearching && (
            <div className="text-center py-32 animate-fadeInUp">
              <div className="relative mb-8">
                <Search className="w-32 h-32 text-gray-300 mx-auto" />
              ...
              <h3 className="text-3xl font-bold text-gray-600 mb-4">Start Your Medicine Search</h3>
